            ...
            <li>
                <ul role="list" class="-mx-2 space-y-1">
                    @foreach($navigation as $key => $link)
                        <li>
                            <a href="{{ $link['href'] }}"
                               class="{{ $link['active'] ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
                            >
                                <x-icons :name="$link['icon']" class="h-6 w-6 shrink-0" />
                                {{ $link['label'] }}
                            </a>
                        </li>
                    @endforeach
