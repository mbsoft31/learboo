...
<div x-data="slideForm({open: false})" class="relative z-40" aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
    <button @click="openSlidePanel()" type="button" class="flex-shrink-0 inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
        {{ $action }}
    </button>
    <div x-show="open" class="fixed inset-0 bg-indigo-950/25"></div>
    <div x-show="open" class="fixed inset-0 overflow-hidden">
        <div class="absolute inset-0 overflow-hidden">
            <div @click.outside="closeSlidePanel()" class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 sm:pl-16">
                <div x-show="open" x-cloak
                    ...
                    <form class="flex h-full flex-col divide-y divide-gray-200 bg-white shadow-xl" action="{{ ($model) ? route('admin.testimonials.update', $model->id) :route('admin.testimonials') }}" method="POST">
                        @csrf
                            ...
                            <div class="bg-indigo-700 px-4 py-6 sm:px-6">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="ml-3 flex h-7 items-center">
                                        <button @click="closeSlidePanel()" type="button" class="relative rounded-md bg-indigo-700 text-indigo-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white">
                            ...
                            <div class="flex flex-1 flex-col justify-between">
                                <div class="divide-y divide-gray-200 px-4 sm:px-6">
                                    <div class="space-y-6 pb-5 pt-6">
                                        <div>
                                            <label for="name" class="block text-sm text-start font-medium leading-6 text-gray-900">
                                                name
                                            </label>
                                            <div class="mt-2">
                                                <input
                                        ...
                                        <div>
                                            <label for="email" class="block text-sm text-start font-medium leading-6 text-gray-900">
                                                email
                                            </label>
                                            <div class="mt-2">
                                                <input
                                        ...
                                        <div>
                                            <label for="position" class="block text-sm text-start font-medium leading-6 text-gray-900">
                                                position
                                            </label>
                                            <div class="mt-2">
                                                <input
                                        ...
                                        <div>
                                            <label for="company" class="block text-sm text-start font-medium leading-6 text-gray-900">
                                                company
                                            </label>
                                            <div class="mt-2">
                                                <input value="{{ $model ? $model->company : '' }}"
                                                    type="text" name="company" id="company" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                            </div>
                                        </div>
                                        <div>
                                            <label for="testimonial" class="block text-sm text-start font-medium leading-6 text-gray-900">Message</label>
                                            <div class="mt-2">
                                                <textarea id="testimonial" name="testimonial" rows="4" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ $model ? $model->testimonial : '' }}</textarea>
                                            </div>
                                        </div>
                                        <div>
                                            <h3 class="text-sm text-start font-medium leading-6 text-gray-900">Team Members</h3>
                                            <div class="mt-2">
                        ...
                        <div class="flex flex-shrink-0 justify-end px-4 py-4">
                            <button @click="closeSlidePanel()" type="button" class="rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Cancel</button>
