...
<div class="relative flex flex-col gap-10 sm:flex-row" {{ $attributes }}>
    ...
    <div class="max-w-xl flex-auto">
        ...
        <ul role="list" class="mt-6 flex gap-x-6">
            <li>
                <a href="{{ $teacher->social['instagram'] }}" target="_blank" class="text-gray-400 hover:text-gray-500">
            ...
            <li>
                <a href="{{ $teacher->social['linkedin'] }}" target="_blank" class="text-gray-400 hover:text-gray-500">
